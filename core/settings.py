...
# SECRET_KEY = 'django-insecure-uwc-lvp0bf=11p%#mn=zc9w6i3!ly+$=v3=j5l03ayi))ljp40'
...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-uwc-lvp0bf=11p%#mn=zc9w6i3!ly+$=v3=j5l03ayi))ljp40',
)
...
# ── Database ─────────────────────────────────────────────────────────
# Na Renderze DATABASE_URL jest ustawiony automatycznie po podpięciu bazy.
# Lokalnie używamy PostgreSQL z lokalnej konfiguracji.
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://michalmetel:12345678@localhost:5432/twoja_baza',
        conn_max_age=600,
        ssl_require=False,
    )
}
